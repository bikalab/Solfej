...
var Solfej = {
  init() {
    ...
    /* Define elements */
    this.videoEl = document.getElementById("Solfej");
    ...
    this.progressBar.addEventListener("mousedown", function(e) {
      ...
      Solfej.onProgressClick(e.pageX);
    });
    ...
    this.progressBar.addEventListener("mouseover", function(e) {
      Solfej.setProgressTooltip(e.pageX);
    });
    ...
    this.videoEl.addEventListener("timeupdate", function() {
      Solfej.updateProgressBar();
      Solfej.tooltipEl.textContent = Solfej.getTooltip(this.currentTime);
    });
